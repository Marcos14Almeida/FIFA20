...
public class PageFragment11 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(globalVariable.SaberCampeonato()<=10){campeonato = 11;}
        else{campeonato=10;}
    ...
    public void PrintarTime(Integer id){
        ...
        if(id>=1 && id <=2)textoNomeTime.setBackgroundColor(Color.rgb(150,180,255));
        if(id>=1 && id <=6 && campeonato==11)textoNomeTime.setBackgroundColor(Color.rgb(150,180,255));
