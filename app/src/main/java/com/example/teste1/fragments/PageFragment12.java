...
public class PageFragment12 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(globalVariable.SaberCampeonato()<=10){campeonato = 12;}
        else{campeonato=11;}
    ...
    public void PrintarTime(Integer id){
        ...
        if(id>=1 && id <=6)textoNomeTime.setBackgroundColor(Color.rgb(150,180,255));
        if(id>=1 && id <=12 && campeonato==12)textoNomeTime.setBackgroundColor(Color.rgb(150,180,255));
        if(id>=15 && id <=16)textoNomeTime.setBackgroundColor(Color.rgb(255,150,150));
