...
public class PageFragment2 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(globalVariable.SaberCampeonato()==1){campeonato = 2;}
        else{campeonato=1;}
    ...
    public void PrintarTime(Integer id){
        ...
        if(campeonato==1 && (id>=2 && id<=8))textoNomeTime.setBackgroundColor(Color.rgb(150,180,255));
        if(id==1)textoNomeTime.setBackgroundColor(Color.rgb(233,208,44));
        if(id>=2 && id <=4)textoNomeTime.setBackgroundColor(Color.rgb(150,180,255));
