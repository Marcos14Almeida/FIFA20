...
public class PageFragment9 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(globalVariable.SaberCampeonato()<=8){campeonato = 9;}
        else{campeonato=8;}
    ...
    public void PrintarTime(Integer id){
        ...
        if(campeonato != 9){if(id>=2 && id <=4)textoNomeTime.setBackgroundColor(Color.rgb(150,180,255));}
        if(campeonato == 9){if(id>=1 && id <=3)textoNomeTime.setBackgroundColor(Color.rgb(150,180,255));}
