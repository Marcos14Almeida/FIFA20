    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(ano>2020 && rodada<rodadaOitavas ){
            ...
            for(int i=1;i<=16;i++) {
                timea=i;
                golsMarcadosMataMataLibertadores=globalVariable.SaberGolsMarcadosMataMataLibertadores();
                golsMarcados=golsMarcadosMataMataLibertadores.get(i);
...
/////////////////////////////////////////////////////////////////////////////////////
    ...
    public void PrintarTime(Integer id,Integer GMouGS, Integer Fase){
        ...
        if(Fase==8){
            if(GMouGS==1){
                globalVariable.imageLogo(timesLibertadoresOitavas.get(timea),imagemTime);
                textoNomeTime.setText(timesLibertadoresOitavas.get(timea));
                textoGolsMarcados.setText(String.valueOf(golsMarcados));}
            if(GMouGS==2){
                globalVariable.imageLogo(timesLibertadoresOitavas.get(timeb),imagemTime);
                textoNomeTime.setText(timesLibertadoresOitavas.get(timeb));
                textoGolsMarcados.setText(" "+String.valueOf(golsSofridos)+" ");}}

        if(Fase==4){
            if(GMouGS==1){
                globalVariable.imageLogo(timesLibertadoresQuartas.get(timea),imagemTime);
                textoNomeTime.setText(timesLibertadoresQuartas.get(timea));
                textoGolsMarcados.setText(String.valueOf(golsMarcados));}
            if(GMouGS==2){
                globalVariable.imageLogo(timesLibertadoresQuartas.get(timeb),imagemTime);
                textoNomeTime.setText(timesLibertadoresQuartas.get(timeb));
                textoGolsMarcados.setText(" "+String.valueOf(golsSofridos)+" ");}}

        if(Fase==2){
            if(GMouGS==1){
                globalVariable.imageLogo(timesLibertadoresSemifinal.get(timea),imagemTime);
                textoNomeTime.setText(timesLibertadoresSemifinal.get(timea));
                textoGolsMarcados.setText(String.valueOf(golsMarcados));}
            if(GMouGS==2){
                globalVariable.imageLogo(timesLibertadoresSemifinal.get(timeb),imagemTime);
                textoNomeTime.setText(timesLibertadoresSemifinal.get(timeb));
                textoGolsMarcados.setText(" "+String.valueOf(golsSofridos)+" ");}}

        if(Fase==1){
            if(GMouGS==1){
                globalVariable.imageLogo(timesLibertadoresFinal.get(timea),imagemTime);
                textoNomeTime.setText(timesLibertadoresFinal.get(timea));
                textoGolsMarcados.setText(String.valueOf(golsMarcados));}
            if(GMouGS==2){
                globalVariable.imageLogo(timesLibertadoresFinal.get(timeb),imagemTime);
                textoNomeTime.setText(timesLibertadoresFinal.get(timeb));
                textoGolsMarcados.setText(" "+String.valueOf(golsSofridos)+" ");}}
